...
const CUSTOM_SERVICES = {
  discord: new CustomService(
    ...
    [
      new CustomReaction(
        'post_message',
        'Posts a message in a specific location',
        ['channel_id', 'body']
      ),
      new CustomReaction(
        'post_joke',
        'Post discord random joke message to a channel',
        ['channel_id']
      ),
      new CustomReaction(
        'post_art',
        'Post discord random art from the met to a channel',
        ['channel_id']
      ),
      new CustomReaction(
        'post_pokemon',
        'Post discord random pokemon to a channel',
        ['channel_id']
      ),
    ],
    () => {},
  ...
  timer: new CustomService(
    [
      ...
      new CustomAction(
        ...
        'Trigger a reaction on the day you want',
        ['year', 'month', 'day', 'hour'],
        () => false
      ),
    ],
  ...
  spotify: new CustomService(
    [
      new CustomAction(
        'last_playlist',
        'Triggers when a is added',
        [],
        () => false
      ),
      new CustomAction(
        'last_song',
        'Triggers when a playlist is added',
        [],
        () => false
      ),
      new CustomAction(
  ...
  gmail: new CustomService(
    [
      new CustomAction(
        'last_mail',
        'Triggers when a new mail is got',
        [],
        () => false
      ),
      new CustomAction(
        'last_mail_from_someone',
        'Triggers when a new mail is got from someone',
        ['sender'],
        () => false
      ),
    ],
