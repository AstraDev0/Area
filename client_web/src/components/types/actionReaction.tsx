...
export const reaction: { [key: string]: ReactionItem[] } = {
    "discord": [
        ...
        { name: "post_quote", description: "post discord random quote to a channel", data: { channel_id: "" } },
        { name: "post_pokemon", description: "post discord random pokemon to a channel", data: { channel_id: "" } },
    ],
    "spotify": [
    ],
    "timer": [
